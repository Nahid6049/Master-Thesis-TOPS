    ...
    return {
        ...
        'generators': {
            'GEN': [
                ...
                ['G3','B10',360,20,300,1.0,4.0,0.0,
                 1.02,0.63,0.25,0.63,0.16,0.16,6.5,1,0.05,0.15],

                ['G4','B10',360,20,0,1.0,4.0,0.0,
                 1.02,0.63,0.25,0.63,0.16,0.16,6.5,1,0.05,0.15],

                ['G5','B10',360,20,0,1.0,4.0,0.0,
                 1.02,0.63,0.25,0.63,0.16,0.16,6.5,1,0.05,0.15],

                ['G6','B10',360,20,0,1.0,4.0,0.0,
                 1.02,0.63,0.25,0.63,0.16,0.16,6.5,1,0.05,0.15],
            ],
        },
        ...
        'gov': {
            'HYGOV': [
                ...
                ['HYGOV1','G1',0.1,1.5,0.1,2.0,1,1,1,
                 0.01,0.01,0,0.1,1,0],

                ['HYGOV3','G3',0.1,1.5,0.1,2.0,1,1,1,
                 0.01,0.01,0,0.1,1,0],

                ['HYGOV4','G4',0.1,1.5,0.1,2.0,1,1,1,
                 0.01,0.01,0,0.1,1,0],

                ['HYGOV5','G5',0.1,1.5,0.1,2.0,1,1,1,
                 0.01,0.01,0,0.1,1,0],

                ['HYGOV6','G6',0.1,1.5,0.1,2.0,1,1,1,
                 0.01,0.01,0,0.1,1,0],
            ],
        },
